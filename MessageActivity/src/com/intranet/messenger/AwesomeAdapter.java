...
public class AwesomeAdapter extends BaseAdapter{
	...
	public AwesomeAdapter(Context context, ArrayList<Message> messages,String mine) {
		super();
...
//		else
//		{		
//			//Check whether message is mine to show green background and align to rights
		System.out.println("position "+position);
//		if(position>0){
			if(message.getSender().equals(this.mine))
			{
